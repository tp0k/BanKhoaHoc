        ...
        <div class="row align-items-center justify-content-md-center">
            <div class="col-lg-5 order-2 order-lg-0">
                <div class="signup-area-textwrapper">
                    <h2 class="font-title--md mb-0">Đăng ký</h2>
                    ...
                    <form action="{{route('studentRegister.store','studentdashboard')}}" method="POST">
                        ...
                        <div class="form-element">
                                ...
                                <input type="text" placeholder="Điền tên của bạn" id="name" value="{{old('name')}}" name="name" />
                                @if($errors->has('name'))
                        ...
                        <div class="form-element">
                            ...
                            <div class="form-alert-input">
                                <input type="password" placeholder="Gõ vào đây..." id="password"  name="password"/>
                        ...
                        <div class="form-element">
                            ...
                            <div class="form-alert-input">
                                <input type="password" placeholder="Gõ vào đây..." name="password_confirmation" id="password_confirmation" />
