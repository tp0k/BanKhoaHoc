            ...
            <nav class="students-info-intro__nav">
                <div class="nav" id="nav-tab" role="tablist">
                    <button class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab"
                        ...
                        aria-selected="true">Hồ sơ của bạn</button>

                    <button class="nav-link" id="nav-setting-tab" data-bs-toggle="tab" data-bs-target="#nav-setting"
                        type="button" role="tab" aria-controls="nav-setting" aria-selected="false">Cài đặt</button>
                </div>
            </nav>
        </div>
                        ...
                        <div class="col-lg-9 order-2 order-lg-0">
                            <div class="white-bg">
                                <div class="students-info-form">
                                    <h6 class="font-title--card">Thông tin của bạn</h6>
                                    <form action="{{route('student_save_profile')}}" method="post">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <label for="fullName_en">Họ tên</label>
                                                <input type="text" class="form-control" name="fullName_en"
                                                    value="{{$student_info->name_en}}" placeholder="Gõ tên của bạn" />
                                            </div>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <input type="text" name="profession" class="form-control"
                                                    ...
                                                    placeholder="Gõ nghề của bạn" />
                                            </div>
                                        </div>
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <label for="contactNumber_en">Số điện thoại</label>
                            ...
                            <div class="white-bg mt-4">
                                <div class="students-info-form">
                                    <h6 class="font-title--card">Đổi mật khẩu</h6>
                                    ...
                                    <form id="changeImageForm" action="{{ route('change_image') }}" method="post"
                                        ...
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <button type="button" id="changeImageButton"
                                                class="button button--primary-outline">ĐỔI ẢNH</button>
                                        </div>
                                    </form>
                                    <p>Kích thước hình ảnh phải dưới 1MB tỷ lệ hình ảnh 200px.</p>
                                </div>
                            </div>
                        </div>
                    </div>
