...
<head>
    ...
    <title>@yield('title','home') - {{ $firstPart }} {{ $secondPart }}</title>
    <link rel="stylesheet" href="{{asset('frontend/dist/main.css')}}" />
    <link rel="icon" type="image/png" href="{{asset('frontend/dist/images/favicon/favicon.jpg')}}" />
...
background-color: #f1f1f1;
    ...
    <style>
        ...
        #myBtn {
            ...
            bottom: 20px;
            right: 20px;
            z-index: 10; /* Đảm bảo nút luôn nằm trên cùng */
        }

        /* CSS cho nút chat Zalo */
        .zalo-chat-button {
            position: fixed;
            bottom: 90px; /* Điều chỉnh khoảng cách so với nút lên đầu trang */
            right: 20px;
            z-index: 20; /* Đảm bảo nút Zalo nằm trên nút lên đầu trang */
        }
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse d-none d-xl-block d-none d-xl-block" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="{{route('searchCourse')}}">Khoá học</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="d-flex align-items-center justify-content-between rightContent">
                        ...
                        <a href="{{route('cart')}}" class="cart-nav border-0 bg-transparent mx-3">
                            ...
                            <span class="visually-hidden">Thêm khoá học</span>
                        </a>
                            ...
                            <ul class="navbar-mobile__menu-list">
                                ...
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('searchCourse')}}">
                                        <span class="navbar-mobile__menu-link"> Khoá học </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="{{route('about')}}">
                                        <span class="navbar-mobile__menu-link"> Về chúng tôi </span>
                                    </a>
                                </li>
                                <li class="navbar-mobile__menu-item">
                                    <a href="#">
                                    ...
                                    <ul class="navbar-mobile__menu-dropmenu">
                                        ...
                                        <li><a href="{{route('student_profile')}}">Thông tin học viên</a></li>
