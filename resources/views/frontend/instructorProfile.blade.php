    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0">
                ...
                <li class="breadcrumb-item"><a href="course-search.html" class="fs-6 text-secondary">Khoá học</a></li>
                <li class="breadcrumb-item d-none d-lg-inline-block"><a href="#"
                        class="fs-6 text-secondary">Giảng viên khoá học</a></li>
                    ...
                    <ul class="nav nav-pills instructor-tabs-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link me-0" id="pills-pills-review-tab" data-bs-toggle="pill"
                                ...
                                aria-selected="false">Giới thiệu</button>
                        </li>
                    </ul>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">Hải Phòng
                                                Học tại Hải Phòng</a>
                                            </h5>
                                            <div
                                                ...
                                                <a href="instructor-profile.html"
                                                    ...
                                                    <p class="font-para--md">Thanh</p>
                                                </a>
                                                <div class="price">
                                                    <span>1.200.000 VNĐ</span>
                                                    <del>9.500.000 VNĐ</del>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">Khoá học lập trinh web</a>
                                            </h5>
                                            <div
                                                class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="instructor-profile.html"
                                                    ...
                                                    <img src="{{asset('frontend/dist/images/courses/lan.png')}}"
                                                        alt="client-image" class="rounded-circle" />
                                                    <p class="font-para--md">Tô Thị Tuyết Lan</p>
                                                </a>
                                                <div class="price">
                                                    <span>12.000.000VNĐ</span>
                                                    <del>24.000.000VNĐ</del>
                                                </div>
                                            </div>
                                            <div class="contentCard-more">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">Khoá học lập trình ứng dụng</a>
                                            </h5>
                                            <div
                                                class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="instructor-profile.html"
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">Khoá học lập trình Scratch</a>
                                            </h5>
                                            <div
                                                class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="instructor-profile.html"
                                                ...
                                                <div class="price">
                                                    <span>14.000.000VNĐ</span>
                                                    <del>95.000.000VNĐ</del>
                                                </div>
                                            </div>
                                            <div class="contentCard-more">
                                                <div class="d-flex align-items-center">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">Khoá học lập trình Python</a>
                                            </h5>
                                            <div
                                                class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="instructor-profile.html"
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="contentCard contentCard--course">
                                        ...
                                        <div class="contentCard-bottom">
                                            <h5>
                                                <a href="#" class="font-title--card">Khoá học Scratch bassic</a>
                                            </h5>
                                            <div
                                                class="contentCard-info d-flex align-items-center justify-content-between">
                                                <a href="instructor-profile.html"
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="students-feedback">
                                        <div class="students-feedback-heading">
                                            <h5>Đánh giá của học sinh <span>(57,685)</span></h5>
                                            <div class="right">
                                                <h6>Sắp xếp theo:</h6>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                                        <li><button class="dropdown-item" type="button">Đánh Giá</button>
                                                        </li>
                                                        <li><button class="dropdown-item" type="button">Đánh giá khác</button></li>
                                                        <li><button class="dropdown-item" type="button">Đánh giá khác ở đây</button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="feedback-comment">
                                        <h6 class="font-title--card">Để lại xếp hạng</h6>
                                        <span>Xếp hạng</span>
                                        ...
                                        <form action="#">
                                            ...
                                            <button type="submit"
                                                class="button button-lg button--primary float-end">Đăng đánh giá</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
