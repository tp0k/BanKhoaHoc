    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <a href="{{route('searchCourse')}}" class="button button-lg button--primary mt-5">Tất cả khóa học</a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-more">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$dc->lesson?$dc->lesson:0}} Video</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$dc->duration?$dc->duration:0}} Giờ</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="tab-pane fade" id="pills-dev" role="tabpanel" aria-labelledby="pills-dev-tab">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$dv->price?'VNĐ'.$dv->price:'Free'}}</span>
                                            <del>{{$dv->old_price?'VNĐ'.$dv->old_price:''}}</del>
                                        </div>
                                    </div>
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                                        ...
                                        <div class="book d-flex align-items-center">
                                            ...
                                            <span>{{$dv->lesson?$dv->lesson:0}} Video</span>
                                        </div>
                                        <div class="clock d-flex align-items-center">
                                            <div class="icon">
                                                <img src="{{asset('frontend/dist/images/icon/Clock.png')}}" alt="clock" />
                                            </div>
                                            <span>{{$dv->duration?$dv->duration:0}} Giờ</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <a href="{{route('searchCourse')}}" class="button button-lg button--primary">Tất cả khóa học</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$bc->price?'VNĐ'.$bc->price:'Free'}}</span>
                                            <del>{{$bc->old_price?'VNĐ'.$bc->old_price:''}}</del>
                                        </div>
                                    </div>
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                            ...
                            <div class="contentCard contentCard--course">
                                ...
                                <div class="contentCard-bottom">
                                    ...
                                    <div class="contentCard-info d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="price">
                                            <span>{{$ic->price?'VNĐ'.$ic->price:'Free'}}</span>
                                            <del>{{$ic->old_price?'VNĐ'.$ic->old_price:''}}</del>
                                        </div>
                                    </div>
                                    <div class="contentCard-more">
                                        <div class="d-flex align-items-center">
                ...
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        ...
                        <div class="testimonial__user-info">
                            <h6> Jenny Tạ</h6>
                            <span class="font-para--md">Học viên lập trình Python</span>
                        </div>
                    </div>
            ...
            <div class="testimonial__item">
                ...
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        ...
                        <div class="testimonial__user-info">
                            <h6>Tô Lan</h6>
                            <span class="font-para--md">Học sinh Lập trình Scratch</span>
                        </div>
                    </div>
                    <ul class="testimonial__item-star d-flex align-items-center">
                        <li>
            ...
            <div class="testimonial__item">
                ...
                <div class="testimonial__user-wrapper d-flex justify-content-between">
                    <div class="testimonial__user d-flex align-items-center">
                        ...
                        <div class="testimonial__user-info">
                            <h6>Đan Nguyễn</h6>
                            <span class="font-para--md">Học sinh Quản trị mạng</span>
                        </div>
                    </div>
                    <ul class="testimonial__item-star d-flex align-items-center">
                        <li>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="main-become-instructor-item me-12">
                    ...
                    <div class="main-text">
                        <h6 class="font-title--sm">Trở thành Giảng viên</h6>
                        <p>
            ...
            <div class="col-lg-6">
                <div class="main-become-instructor-item ms-12 mb-0">
                    ...
                    <div class="main-text">
                        <h6 class="font-title--sm">Trở thành học viên.</h6>
                        <p>
                            Trở thành học viên.
                        </p>
                        <div class="text-center">
