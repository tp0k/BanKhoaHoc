        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('message.index')}}">Tin nhắn</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('message.index')}}">Tất cả tin nhắn</a>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <ul class="nav nav-pills mb-3">
                    <li class="nav-item"><a href="#list-view" data-toggle="tab"
                            class="nav-link btn-primary mr-1 show active">Chế độ hiển thị theo danh sách</a></li>
                    <li class="nav-item"><a href="javascript:void(0);" data-toggle="tab"
                            class="nav-link btn-primary">Chế độ hiển thị theo ô</a></li>
                </ul>
            </div>
            <div class="col-lg-12">
