        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0);">Sửa lựa chọn</a></li>
                </ol>
            </div>
        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="questionId">
                                            ...
                                            <option value="{{$q->id}}" {{old('questionId', $option->question_id) ==
                                                ...
                                                {{$q->content}}</option>
                                            @empty
                                            <option value="">Không tìm thấy câu trả lời</option>
                                            @endforelse
                                        </select>
                                    </div>
                               ...
                               <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="is_correct">
                                        <option value="1" @if(old('is_correct',$option->is_correct)==1) selected @endif>Đúng</option>
                                        <option value="0" @if(old('is_correct',$option->is_correct)==0) selected @endif>Sai</option>
                                    </select>
                                </div>
                            </div>
