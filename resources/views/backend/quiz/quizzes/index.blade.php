        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('quiz.index')}}">Tất cả Quiz</a>
                    </li>
                </ol>
            </div>
        </div>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{route('quiz.create')}}" class="btn btn-primary">Thêm mới</a>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="4" class="text-center">Không thấy Quiz</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
