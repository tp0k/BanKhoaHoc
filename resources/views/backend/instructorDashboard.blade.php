        ...
        <div class="row">
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-primary overflow-hidden">
                    <div class="card-header">
                        <h3 class="card-title text-white">Tổng số học viên</h3>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-secondary overflow-hidden">
                    <div class="card-header pb-3">
                        <h3 class="card-title text-white">Tổng số khóa học</h3>
            ...
            <div class="col-xl-3 col-xxl-3 col-sm-6">
                <div class="widget-stat card bg-danger overflow-hidden">
                    <div class="card-header pb-3">
                        <h3 class="card-title text-white">Thu tổng phí</h3>
                            ...
                            <table class="table header-border table-hover verticle-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Lan Tô Thị</td>
                                        <td><span class="badge badge-rounded badge-warning">Đang chờ đợi</span></td>
                                        <td>
                                            <div class="progress">
                                    ...
                                    <tr>
                                        <th>6</th>
                                        <td>Quản lý Báo cáo Giao diện</td>
                                        <td>Đan Nguyễn</td>
                                        <td><span class="badge badge-rounded badge-primary">DONE</span></td>
                                        <td>
                                            <div class="progress">
                            ...
                            <ul class="timeline">
                                <li>
                                    ...
                                    <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                        ...
                                        <div class="col">
                                            ...
                                            <small class="d-block">29 Tháng 3 2024 - 02:26 PM</small>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    ...
                                    <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                        ...
                                        <div class="col">
                                            <h5 class="mb-1">Tạo báo cáo hoàn tất</h5>
                                            <small class="d-block">29 Tháng 3 2024 - 02:26 PM</small>
                                        </div>
                                    </a>
                                </li>
                                <li>
                                    ...
                                    <a class="timeline-panel text-muted mb-3 d-flex align-items-center"
                                        ...
                                        <div class="col">
                                            <h5 class="mb-1">Chú ý: Thời gian hoàn thành!</h5>
                            ...
                            <table class="table table-sm mb-0 table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="py-3">Giáo viên được chỉ định</th>
                                        <th class="py-3">Bộ phận</th>
                                        <th class="py-3">Trạng thái</th>
                                        <th class="py-3">Ngày chấp thuận</th>
                                ...
                                <tbody id="customers">
                                            ...
                                            <a href="javascript:void(0);">
                                                <div class="media d-flex align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-0 fs--1">Quỳnh Trần JP</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </td>
                                        <td class="py-2">Tạ Thị Phương Thảo</td>
                                    ...
                                    <tr class="btn-reveal-trigger">
                                        ...
                                        <td class="py-2">Khoa học máy Tính</td>
                                        <td><span class="badge badge-rounded badge-warning">Đang chờ đợi</span></td>
                                        ...
                                        <td class="p-3">
                                            <a href="javascript:void(0);">
                                                <div class="media d-flex align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-0 fs--1">Tô Thị Tuyết Lan</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </td>
                                        <td class="py-2">Tô Thị Tuyết Lan</td>
                                        <td class="py-2">Lao Công</td>
                                        <td><span class="badge badge-rounded badge-primary">DONE</span></td>
                                        ...
                                        <td class="p-3">
                                            <a href="javascript:void(0);">
                                                <div class="media d-flex align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-0 fs--1">Tạ Thị Phương Thảo</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </td>
                                        <td class="py-2">Trang</td>
                                        <td class="py-2">Máy tính</td>
                                        <td><span class="badge badge-rounded badge-danger">Đang khoá</span></td>
                                        <td class="py-2">05/04/2023</td>
                                        <td>
                                            <a href="edit-student.html" class="btn btn-sm btn-primary"><i
                                                    class="la la-pencil"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-sm btn-danger"><i
                                    ...
                                    <tr class="btn-reveal-trigger">
                                        <td class="p-3">
                                            <a href="javascript:void(0);">
                                                <div class="media d-flex align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-0 fs--1">Trần Tuyết</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </td>
                                        <td class="py-2">Đan Nguyễn</td>
                                        <td class="py-2">Khoa học máy tính</td>
                                        <td><span class="badge badge-rounded badge-danger">Đang chờ</span></td>
                                        <td class="py-2">12/07/2016</td>
                                        <td>
                                            <a href="edit-student.html" class="btn btn-sm btn-primary"><i
                                                    class="la la-pencil"></i></a>
                                            <a href="javascript:void(0);" class="btn btn-sm btn-danger"><i
                                        ...
                                        <td class="p-3">
                                            <a href="javascript:void(0);">
                                                <div class="media d-flex align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="mb-0 fs--1">Thảo</h5>
                                                    </div>
                                                </div>
                                            </a>
                                        </td>
                                        <td class="py-2">Thảo</td>
                                        <td class="py-2">Cơ khí</td>
                                        <td><span class="badge badge-rounded badge-warning">Đang chờ</span></td>
