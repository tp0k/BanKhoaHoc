        ...
        <div class="row page-titles mx-0">
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('user.index')}}">Tài khoản</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('user.index')}}">Tất cả tài khoản</a></li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <ul class="nav nav-pills mb-3">
                    <li class="nav-item"><a href="#list-view" data-toggle="tab"
                            class="nav-link btn-primary mr-1 show active">Xem danh sách</a></li>
                    ...
                    <div id="list-view" class="tab-pane fade active show col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tất cả danh sách học sinh </h4>
                                ...
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            @empty
                                            <tr>
                                                <th colspan="7" class="text-center">Không tìm thấy tài khoản</th>
                                            </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right border py-0">
                                                <div class="py-2">
                                                    <a class="dropdown-item"
                                                        href="{{route('user.edit', encryptor('encrypt',$d->id))}}">Sửa</a>
                                    ...
                                    <div class="card-body pt-2">
                                        <div class="text-center">
                                            ...
                                            <ul class="list-group mb-3 list-group-flush">
                                                ...
                                                <li class="list-group-item px-0 d-flex justify-content-between">
                                                    <span class="mb-0">Toàn quyền truy cập :</span>
                                                    <span class="badge {{$d->full_access==1?"
                                                        badge-info":"badge-warning"}}">@if($d->full_access==1){{__('Yes')}}
                                                        @else{{__('No')}} @endif</span>
                                                </li>
